<?php
namespace Xtento\TrackingImport\Controller\Adminhtml\Manual\Index;

/**
 * Interceptor class for @see \Xtento\TrackingImport\Controller\Adminhtml\Manual\Index
 */
class Interceptor extends \Xtento\TrackingImport\Controller\Adminhtml\Manual\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\App\Action\Context $context, \Xtento\TrackingImport\Helper\Module $moduleHelper, \Xtento\XtCore\Helper\Cron $cronHelper, \Xtento\TrackingImport\Model\ResourceModel\Profile\CollectionFactory $profileCollectionFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Xtento\TrackingImport\Model\ProfileFactory $profileFactory)
    {
        $this->___init();
