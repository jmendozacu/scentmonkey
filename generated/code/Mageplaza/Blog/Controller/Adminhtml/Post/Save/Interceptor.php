...
class Interceptor extends \Mageplaza\Blog\Controller\Adminhtml\Post\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\Registry $registry, \Mageplaza\Blog\Model\PostFactory $postFactory, \Magento\Backend\Helper\Js $jsHelper, \Mageplaza\Blog\Helper\Image $imageHelper, \Mageplaza\Blog\Helper\Data $helperData, \Mageplaza\Blog\Model\PostHistoryFactory $postHistory, \Magento\Framework\Stdlib\DateTime\DateTime $date)
    {
        $this->___init();
        parent::__construct($context, $registry, $postFactory, $jsHelper, $imageHelper, $helperData, $postHistory, $date);
    }
