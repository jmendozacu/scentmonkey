<?php
namespace Magento\Cron\Model\Schedule;

/**
 * Interceptor class for @see \Magento\Cron\Model\Schedule
 */
class Interceptor extends \Magento\Cron\Model\Schedule implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, ?\Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, ?\Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = [], ?\Magento\Framework\Stdlib\DateTime\TimezoneInterface $timezoneConverter = null, ?\Magento\Framework\Intl\DateTimeFactory $dateTimeFactory = null)
    {
        $this->___init();
        parent::__construct($context, $registry, $resource, $resourceCollection, $data, $timezoneConverter, $dateTimeFactory);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCronExpr');
        if (!$pluginInfo) {
            return parent::setCronExpr($expr);
        } else {
            return $this->___callPlugins('setCronExpr', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'trySchedule');
        if (!$pluginInfo) {
            return parent::trySchedule();
        } else {
            return $this->___callPlugins('trySchedule', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'matchCronExpression');
        if (!$pluginInfo) {
            return parent::matchCronExpression($expr, $num);
        } else {
            return $this->___callPlugins('matchCronExpression', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNumeric');
        if (!$pluginInfo) {
            return parent::getNumeric($value);
        } else {
            return $this->___callPlugins('getNumeric', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'tryLockJob');
        if (!$pluginInfo) {
            return parent::tryLockJob();
        } else {
            return $this->___callPlugins('tryLockJob', func_get_args(), $pluginInfo);
        }
    }
