...
class TotalsExtension extends \Magento\Framework\Api\AbstractSimpleObject implements TotalsExtensionInterface
{
    ...
    {
        return $this->_get('avatax_messages');
    }

    /**
     * @param string[] $avataxMessages
     * @return $this
     */
    public function setAvataxMessages($avataxMessages)
    {
        $this->setData('avatax_messages', $avataxMessages);
        return $this;
    }
}
