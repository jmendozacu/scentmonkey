...
var subscription=shippingService.getShippingRates().subscribe(function(){shippingService.isLoading(true);collectionPoints.reloadCheckoutData().always(function(){shippingService.isLoading(false);});subscription.dispose();});}).fail(function(){shippingService.isLoading(false);});};});