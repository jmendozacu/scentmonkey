...
return result;},submitForm:function(){if(this.zipValue().trim().length){searchAction(this.zipValue(),this.countryValue());this.zipCodeError('');}else{this.zipCodeError('This is a required field.');}}});});