define(['ko','Temando_Shipping/js/model/collection-points','Temando_Shipping/js/model/pickup-locations'],function(ko,collectionPoints,pickupLocations){'use strict';var userValue=ko.observable('');var selected=ko.pureComputed({read:function(){if(userValue()===''){if(collectionPoints.getSearchRequest()){return'toCollectionPoint';}
