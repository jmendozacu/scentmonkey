...
<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0">
    <channel>
        ...
        $setup->getConnection()->insertMultiple($setup->getTable('mageplaza_orderexport_defaulttemplate'), $sampleTemplates);
