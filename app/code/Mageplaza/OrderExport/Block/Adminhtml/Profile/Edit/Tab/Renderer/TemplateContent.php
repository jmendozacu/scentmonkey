...
class TemplateContent extends Element implements RendererInterface
{
    ...
    public function getProfileAttrCollection()
    {
        ...
        $attrCollection = [
            'order_general'   => ['label' => __('%1 General Attributes', $name), 'values' => [], 'type' => $profileType],
            'order_customer'  => ['label' => __('%1 Customer Attributes', $name), 'values' => [], 'type' => $profileType],
            'order_shipping'  => ['label' => __('%1 Shipping Attributes', $name), 'values' => [], 'type' => $profileType],
            'order_discount'  => ['label' => __('%1 Discount Attributes', $name), 'values' => [], 'type' => $profileType],
        ...
        if ($profileType !== Profile::TYPE_ORDER) {
            ...
            $attrCollection['order_customer']['values'][] = ['COLUMN_NAME' => 'customer_lasttname'];
