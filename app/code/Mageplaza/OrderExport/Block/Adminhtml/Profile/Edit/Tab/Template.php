...
class Template extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $rendererBlock = $this->getLayout()->createBlock('Mageplaza\OrderExport\Block\Adminhtml\Profile\Edit\Tab\Renderer\TemplateContent');
        ...
        $rendererBlock = $this->getLayout()
            ->createBlock('Mageplaza\OrderExport\Block\Adminhtml\Profile\Edit\Tab\Renderer\TemplateContent')
        ...
        $refField    = $this->fieldFactory->create(['fieldData' => ['value' => 'csv,txt,tsv', 'separator' => ','], 'fieldPrefix' => '']);
        $xmlRefField = $this->fieldFactory->create(['fieldData' => ['value' => 'xml,excel_xml,json', 'separator' => ','], 'fieldPrefix' => '']);
