    ...
    public function execute()
    {
        ...
        foreach ($collection as $profile) {
            try {
                ...
                $this->_getSession()->addException($e, __('Something went wrong while deleting for %1.', $profile->getName()));
            }
        }

        if ($profileDeleted) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been deleted.', $profileDeleted));
        }
