...
class CreateCustomerProfileTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->adapter = $this->getMockBuilder(AuthorizeAdapter::class)
            ->disableOriginalConstructor()
            ->setMethods(['createCustomerProfile'])
            ->getMock();
        ...
        $this->model = new CreateCustomerProfile(
            $this->criticalLogger,
            $this->logger,
            $adapterFactory,
            $this->dataObject
    ...
    public function testPlaceRequestException()
    {
        $this->logger->method('debug')
            ->with([
                ...
                'client' => CreateCustomerProfile::class,
                'response' => []
            ]);
        ...
        $this->adapter->method('createCustomerProfile')
            ->with([
