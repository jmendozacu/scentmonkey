...
use TNW\AuthorizeCim\Gateway\Http\Client\TransactionAuthorize;
...
class TransactionAuthorizeTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->model = new TransactionAuthorize(
            $this->criticalLogger,
            $this->logger,
            $adapterFactory,
            $this->dataObject
    ...
    public function testPlaceRequestException()
    {
        $this->logger->method('debug')
            ->with([
                ...
                'client' => TransactionAuthorize::class,
                'response' => []
            ]);
